...
const GEN_INTERVAL_MS = 130; // how often the simulation advances
const MAX_AGE = 10; // used to fade cell color as they survive
const SPARK_CHANCE = 0.00055; // per-cell chance per tick of a "cosmic ray" birth when population is low
const LOW_POP_FRACTION = 0.012; // if live fraction drops below this, sparks kick in
